        ...
        <View style={styles.container}>
            ...
            <View style={styles.onboardingMessageContainer}>
                ...
                <View style={styles.submessageContainer}>
                    <Text style={{flex: 1, color: COLORS.WHITE, fontSize: 14, lineHeight: 30, letterSpacing: 1}}>Read books online easily via {'\n'}E-Library Management System</Text>
                    <View style={{backgroundColor: COLORS.LIGHT_WHITE, borderRadius: 10}}>
                        <TouchableOpacity style={{padding: 6}} onPress={() => navigation.navigate('HomeScreen')}>
